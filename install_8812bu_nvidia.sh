...
# Este script instala de forma automatizada os drivers da placa de rede wifi Realtek 8812bu e também os drivers de vídeo nvidia mais recentes, além de algumas ferramentas básicas de rede
